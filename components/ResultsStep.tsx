        ...
        <div className="p-4 bg-surface-muted/30 border-t border-border flex items-center justify-between text-xs text-muted">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline">
              <kbd className="px-1.5 py-0.5 bg-surface rounded border border-border text-[10px]">M</kbd> Media Library
            </span>
            <span className="hidden sm:inline">
              <kbd className="px-1.5 py-0.5 bg-surface rounded border border-border text-[10px]">U</kbd> Upload
            </span>
            <span className="hidden sm:inline">
